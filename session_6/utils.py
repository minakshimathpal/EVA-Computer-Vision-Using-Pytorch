...
def get_dataloader_cifar10(batch_size,
  ...
  if train_transforms is None:
    train_transforms= albumentations.pytorch.transforms.ToTensor()

  if test_transforms is None:
    test_transforms = albumentations.pytorch.transforms.ToTensor() 

  train_set= datasets.CIFAR10(root="./data",
                              train=True,
                              transform=train_transforms,
                              download=True)
  valid_set= datasets.CIFAR10(root="./data",
                              train=True,
